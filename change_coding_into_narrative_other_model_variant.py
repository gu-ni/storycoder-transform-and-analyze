...
from instruction_template import INSTRUCTION_HUMANEVAL, INSTRUCTION_INCLUDING_HINTS, genres, INSTRUCTION_THREE_COMPONENTS_ALGORITHM, GEMINI_PARAPHRASE
...
def main(args):
    ...
    if mode == "narrative":
        ...
        output_jsonl_name_list = [
            ...
            "codeforces_longer_narrative_by_llm.jsonl",
        ]
    elif mode == "paraphrase":
        system_prompt = "You are a helpful assistant who follows instructions well."
        output_jsonl_name_list = [
            # "humaneval_filtered_paraphrase_by_llm.jsonl",
            # "test6_paraphrase_by_llm.jsonl",
            # "codeforces_paraphrase_by_llm.jsonl",
            # "codeforces_mid_paraphrase_by_llm.jsonl",
            # "codeforces_challenging_paraphrase_by_llm.jsonl",
            "codeforces_longer_paraphrase_by_llm.jsonl",
        ]
    ...
    input_jsonl_path_list = [
        ...
        "/home/work/users/PIL_ghj/LLM/datasets/codeforces/codeforces_longer_in_lcb_format.jsonl",
    ]

    output_path_list = [
        # f"/home/work/users/PIL_ghj/LLM/datasets/Ablation/diff_quality_search_algorithm/{model_name}/HumanEval",
        # f"/home/work/users/PIL_ghj/LLM/datasets/Ablation/diff_quality_search_algorithm/{model_name}/LiveCodeBench",
        # f"/home/work/users/PIL_ghj/LLM/datasets/Ablation/diff_quality_search_algorithm/{model_name}/CodeForces",
        # f"/home/work/users/PIL_ghj/LLM/datasets/Ablation/diff_quality_search_algorithm/{model_name}/CodeForces",
        # f"/home/work/users/PIL_ghj/LLM/datasets/Ablation/diff_quality_search_algorithm/{model_name}/CodeForces",
        f"/home/work/users/PIL_ghj/LLM/datasets/Ablation/diff_quality_search_algorithm/{model_name}/CodeForces",
    ]
    ...
    for input_jsonl_path, output_path, output_jsonl_name in zip(input_jsonl_path_list, output_path_list, output_jsonl_name_list):
        try:
            ...
            if os.path.exists(output_jsonl_path):
                ...
                print(f"[Info] Existing file removed: {output_jsonl_path}")
            if os.path.exists(log_path):
                os.remove(log_path)
                print(f"[Info] Existing log removed: {log_path}")
            ...
            with open(log_path, "a", encoding="utf-8") as log_file, \
                ...
                def flush_batch():
                    ...
                    for (problem, _), result in zip(current_batch, results):
                        ...
                        outputs = [out.text.strip() for out in result.outputs]
                        if mode == "narrative":
                            problem["narratives"] = outputs
                        elif mode == "paraphrase":
                            problem["paraphrases"] = outputs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_samples", type=int, default=1, help="Number of responses per prompt")
    parser.add_argument("--mode", type=str, default="narrative", choices=["narrative", "paraphrase"])
